<template>
    <MainContainer>
        ...
        <div v-if="state.character" class="bg-black/20 border-black/20 border-2 shadow-lg mx-auto max-w-[1000px] lg:max-w-none lg:w-[1000px] rounded md:rounded-l-full">
